...
fn parallel_test() {
  ...
  let factory_cache = Arc::new(FactoryCache::new(BTreeMap::new(), generate_square));
  ...
  for i in 0..THREAD_COUNT {
    ...
    thread_handles.push(thread::spawn(move || {
      bar.wait();
      execute_workload(thread_id, factory.as_ref());
    }));
  }
...
fn execute_workload(thread_id: usize, factory_cache: &FactoryCache<i64, i64, BTreeMap<i64, Arc<i64>>>) {
